...
class CrosstabResult(BaseResult):
    def __init__(
        self, unique_id, settings_panel_index, title=None, title_context=None, config: CrosstabStudyConfig = None
    ):
