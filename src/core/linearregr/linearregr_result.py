...
class LinearregrResult(BaseResult):
    def __init__(
        self, unique_id, settings_panel_index, title=None, title_context=None, config: LinearregrStudyConfig = None
    ):
        ...
        if title is None:
            title = f"Linearregr, id={unique_id}"
        self.title = title
