...
from src.modules.kruskalwallis.kruskalwallis_result import KruskalWallisResult, KruskalWallisStudyConfig
from src.modules.kruskalwallis.main import recalculate_kruskalwallis_study

if TYPE_CHECKING:
    pass


class KruskalWallis(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[KruskalWallisResult, None] = None
        self.elements = {
            "title2": Title(
                parent_widget=self.widget_for_elements,
                label_text="KruskalWallis",
            ),
    ...
    @log_method
    def configure(self, result: KruskalWallisResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_kruskalwallis_study(
    ...
    def study_settings_changed(self):
        ...
        config = KruskalWallisStudyConfig(
