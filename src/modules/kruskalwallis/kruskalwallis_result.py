...
class KruskalWallisStudyConfig:
    def __init__(
        self,
...
class KruskalWallisResult(BaseResult):
    def __init__(
        self, unique_id, settings_panel_index, title=None, title_context=None, config: KruskalWallisStudyConfig = None
    ):
        ...
        if title is None:
            title = f"Kruskalwallis, id={unique_id}"
        self.title = title
