...
from src.modules.reliability.reliability_result import ReliabilityResult, ReliabilityStudyConfig
...
class Reliability(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[ReliabilityResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: ReliabilityResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_reliability_study(
