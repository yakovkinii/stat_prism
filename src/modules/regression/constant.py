...
<div>
    ...
    independent variables. A regression analysis makes it possible to infer or predict another variable based on one or 
    more variables. Regression analyses are divided into simple linear regression, multiple linear regression and 
    logistic regression. The type of regression analysis that should be used, depends on the number of independent 
    variables and the scale of measurement of the dependent variable.
...
<b>Regression metrics:</b><br>
    ...
    variable. 0 < R² < 1: The closer R² is to 1, the more variance in the dependent variable is explained by the independent 
    variables. The closer R² is to 0, the less the independent variables explain the variation in the dependent variable.
