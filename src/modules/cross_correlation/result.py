...
CROSS_CORRELATION_TYPE_MAP = {
    "Pearson": CrossCorrelationType.PEARSON,
    "Spearman": CrossCorrelationType.SPEARMAN,
    "Kendall": CrossCorrelationType.KENDALL,
}


class CrossCorrelationStudyConfig:
    def __init__(
        self,
        selected_columns1: List[str] = None,
        selected_columns2: List[str] = None,
        cross_correlation_type: CrossCorrelationType = CrossCorrelationType.PEARSON,
        compact: bool = False,
        ...
        self.cross_correlation_type = cross_correlation_type
        self.report_only_significant = report_only_significant
        self.filters: List[FilterSettings] = filters if filters is not None else []


class CrossCorrelationResult(BaseResult):
    def __init__(self, unique_id, settings_panel_index, title, title_context, config: CrossCorrelationStudyConfig):
        ...
        self.config: CrossCorrelationStudyConfig = config
