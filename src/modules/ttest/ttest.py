...
from src.modules.ttest.main import recalculate_ttest_study
from src.modules.ttest.ttest_result import TTestResult, TTestStudyConfig
...
class TTest(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[TTestResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: TTestResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_ttest_study(
