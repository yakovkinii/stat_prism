...
from src.modules.linearregr.linearregr_result import LinearregrResult, LinearregrStudyConfig
from src.modules.linearregr.main import recalculate_linearregr_study

if TYPE_CHECKING:
    pass


class Linearregr(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[LinearregrResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: LinearregrResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_linearregr_study(
