...
from src.modules.t_test.main import recalculate_t_test_study
from src.modules.t_test.result import TTestStudyConfig
...
class TTest(BaseModulePanel):
    def setup_ui(self):
        self.elements = {
            "title": Title(label_text="Independent Samples T-Test"),
            "spacer": SpacerSmall(),
    ...
    def recalculate(self):
        ...
        RESULTS[self.result_id] = recalculate_t_test_study(df=self.tabledata.get_data(), result=RESULTS[self.result_id])
