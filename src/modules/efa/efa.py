...
from src.modules.efa.efa_result import EFAResult, EFAStudyConfig
from src.modules.efa.main import recalculate_efa_study

if TYPE_CHECKING:
    pass


class EFA(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[EFAResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: EFAResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_efa_study(
