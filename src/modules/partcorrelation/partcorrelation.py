...
from src.modules.partcorrelation.main import recalculate_partcorrelation_study
from src.modules.partcorrelation.partcorrelation_result import PartCorrelationResult, PartCorrelationStudyConfig

if TYPE_CHECKING:
    pass


class PartCorrelation(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[PartCorrelationResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: PartCorrelationResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_partcorrelation_study(
    ...
    def study_settings_changed(self):
        ...
        config = PartCorrelationStudyConfig(
