...
from src.modules.multinomiallogregression.main import recalculate_multinomiallogregression_study
from src.modules.multinomiallogregression.multinomiallogregression_result import (
    MultinomialLogRegressionResult,
    MultinomialLogRegressionStudyConfig,
)
...
class MultinomialLogRegression(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[MultinomialLogRegressionResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: MultinomialLogRegressionResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_multinomiallogregression_study(
    ...
    def study_settings_changed(self):
        ...
        config = MultinomialLogRegressionStudyConfig(
