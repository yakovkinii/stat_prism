...
from src.modules.anova.anova_result import AnovaResult, AnovaStudyConfig
from src.modules.anova.main import recalculate_anova_study
...
class Anova(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[AnovaResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: AnovaResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_anova_study(
