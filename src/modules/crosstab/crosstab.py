...
from src.modules.crosstab.crosstab_result import CrosstabResult, CrosstabStudyConfig
from src.modules.crosstab.main import recalculate_crosstab_study

if TYPE_CHECKING:
    pass


class Crosstab(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[CrosstabResult, None] = None
        self.elements = {
            "title2": Title(
    ...
    @log_method
    def configure(self, result: CrosstabResult, caller_index=None):
        ...
        self.elements["column_selector"].configure(
            columns=all_columns, selected_columns=config.selected_columns, allowed_columns=all_columns
        )
    ...
    def recalculate(self):
        ...
        new_result = recalculate_crosstab_study(
