...
from src.modules.binomiallogregression.binomiallogregression_result import (
    BinomialLogRegressionResult,
    BinomialLogRegressionStudyConfig,
)
from src.modules.binomiallogregression.main import recalculate_binomiallogregression_study

if TYPE_CHECKING:
    pass


class BinomialLogRegression(BaseModulePanel):
    def __init__(self, parent_widget, parent_class, root_class, stacked_widget_index):
        ...
        self.result: Union[BinomialLogRegressionResult, None] = None
        self.elements = {
            "title2": Title(
                parent_widget=self.widget_for_elements,
                label_text="BinomialLogRegressionResult",
            ),
    ...
    @log_method
    def configure(self, result: BinomialLogRegressionResult, caller_index=None):
    ...
    def recalculate(self):
        ...
        new_result = recalculate_binomiallogregression_study(
    ...
    def study_settings_changed(self):
        ...
        config = BinomialLogRegressionStudyConfig(
