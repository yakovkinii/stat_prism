...
from src._result_display_panel.result_widget_containers.combined_result_widget_container import (
    CombinedResultElementWidgetContainer,
)
from src._result_display_panel.result_widget_containers.registry import result_widget_container_registry
