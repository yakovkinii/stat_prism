...
from src.trashcan.correlation.core.report import get_report
from src.trashcan.correlation.core.table import get_table
from src.trashcan.correlation.objects import CorrelationResult, CorrelationStudyMetadata
...
def run_correlation_study(
    df: pd.DataFrame, metadata: CorrelationStudyMetadata, result_id: int, comment: str = None
) -> CorrelationResult:
