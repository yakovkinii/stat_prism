...
_ASSUMPTIONS_FINE_PRINT_EN = (
    ...
    "<li><b>Loadings are point estimates.</b> This estimator does not report standard errors "
    "or significance tests for individual loadings, nor modification indices &mdash; judge "
    "loadings by their magnitude.</li>"
