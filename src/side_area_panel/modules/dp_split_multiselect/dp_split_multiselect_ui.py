...
class Elements(ItemInSidePanelWithAutoConfigHolder):
    ...
    delimiter = IISPWACLongTextEdit(label_text="Delimiter (default , ):")
    prefix = IISPWACLongTextEdit(label_text="New column name prefix (optional):")


class SplitMultiSelect(BaseModulePanel):
    def setup_ui(self):
        self.init_elements(Elements)
        self.set_label("Split Multi-Select")
