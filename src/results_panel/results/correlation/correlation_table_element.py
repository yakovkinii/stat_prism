...
class CorrelationTableResultElement(BaseResultElement):
    def __init__(self, html, title="Table Result Element"):
        super().__init__()
        self.title: str = title
        self.class_id: str = "CorrelationTableResultElement"

        self.html = html


class CorrelationTableResultElementWidgetContainer:
    def __init__(self, parent_widget, result_element: CorrelationTableResultElement):
        ...
        # html = self.get_html()
        html = APA_TABLE_STYLE_CLASSES + f'<div class="scrollable">{self.result_element.html}</div>'
