...
from src.core.kruskalwallis.kruskalwallis_result import KruskalWallisResult, KruskalWallisStudyConfig
from src.core.kruskalwallis.main import recalculate_kruskalwallis_study
...
class KruskalWallis(BaseSettingsPanel):
