...
from src.core.partcorrelation.main import recalculate_partcorrelation_study
from src.core.partcorrelation.partcorrelation_result import PartCorrelationResult, PartCorrelationStudyConfig
...
class PartCorrelation(BaseSettingsPanel):
