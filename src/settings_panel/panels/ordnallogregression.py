...
from src.core.ordnallogregression.main import recalculate_ordnallogregression_study
from src.core.ordnallogregression.ordnallogregression_result import (
...
class OrdnalLogRegression(BaseSettingsPanel):
