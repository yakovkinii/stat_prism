...
from src.core.binomiallogregression.binomiallogregression_result import (
    BinomialLogRegressionResult,
    BinomialLogRegressionStudyConfig,
)
from src.core.binomiallogregression.main import recalculate_binomiallogregression_study
...
class BinomialLogRegression(BaseSettingsPanel):
