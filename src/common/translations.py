...
TRANSLATIONS = {
    ...
    "mean_comparison.fine_print": {
        ...
        "ua": (
            ...
            "<li>Родина ANOVA не наводить статистику розміру ефекту &mdash; перемикач "
            "&ldquo;Розмір ефекту / Апостеріорні&rdquo; керує лише апостеріорними тестами.</li>"
            "</ul></li>"
    ...
    "regression.fine_print": {
        ...
        "ua": (
            ...
            "відхилення вказують на ненормальні залишки.</li>"
